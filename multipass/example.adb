...
package body Example is
  ...
  begin
    ...
    MeshData.TexCoords := new Mesh.TexCoordArray(0 .. TotalVertices - 1);
    ...
    MeshData.TexCoords(0) := (0.0, 1.0);
    MeshData.TexCoords(1) := (1.0, 1.0);
    MeshData.TexCoords(2) := (1.0, 0.0);
    MeshData.TexCoords(3) := (0.0, 0.0);
    ...
    MeshData.TexCoords(4) := (0.0, 0.0);
    MeshData.TexCoords(5) := (1.0, 0.0);
    MeshData.TexCoords(6) := (1.0, 1.0);
    MeshData.TexCoords(7) := (0.0, 1.0);
    ...
    MeshData.TexCoords(8) := (0.0, 0.0);
    MeshData.TexCoords(9) := (1.0, 0.0);
    MeshData.TexCoords(10) := (1.0, 1.0);
    MeshData.TexCoords(11) := (0.0, 1.0);
    ...
    MeshData.TexCoords(12) := (0.0, 0.0);
    MeshData.TexCoords(13) := (1.0, 0.0);
    MeshData.TexCoords(14) := (1.0, 1.0);
    MeshData.TexCoords(15) := (0.0, 1.0);
    ...
    MeshData.TexCoords(16) := (0.0, 0.0);
    MeshData.TexCoords(17) := (1.0, 0.0);
    MeshData.TexCoords(18) := (1.0, 1.0);
    MeshData.TexCoords(19) := (0.0, 1.0);
    ...
    MeshData.TexCoords(20) := (0.0, 0.0);
    MeshData.TexCoords(21) := (1.0, 0.0);
    MeshData.TexCoords(22) := (1.0, 1.0);
    MeshData.TexCoords(23) := (0.0, 1.0);
  ...
  begin
    ...
    GradientTexture := SDL.Video.LoadBMP("../assets/gradient.bmp");

    if GradientTexture /= null then

      GL.glGenTextures(1, Address_To_GLuintPtr(GradientTextureID'Address));
      GL.glBindTexture(GL.GL_TEXTURE_2D, GradientTextureID);
      GL.glTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_RGB, GL.GLsizei(GradientTexture.w), GL.GLsizei(GradientTexture.h), 0, GL.GL_BGR, GL.GL_UNSIGNED_BYTE, Address_To_GLpointer(GradientTexture.Pixels));
      GL.glTexParameteri(GL.GL_TEXTURE_2D, GL.GL_TEXTURE_MIN_FILTER, GL.GL_LINEAR);
      GL.glTexParameteri(GL.GL_TEXTURE_2D, GL.GL_TEXTURE_MAG_FILTER, GL.GL_LINEAR);

      -- TODO: Free the texture surface.
      SDL.Video.FreeSurface(GradientTexture);
    ...
    -- Generate the texture.
    SaturationTexture := SDL.Video.LoadBMP("../assets/saturation.bmp");

    if SaturationTexture /= null then

      GL.glGenTextures(1, Address_To_GLuintPtr(SaturationTextureID'Address));
      GL.glBindTexture(GL.GL_TEXTURE_2D, SaturationTextureID);
      GL.glTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_LUMINANCE, GL.GLsizei(SaturationTexture.w), GL.GLsizei(SaturationTexture.h), 0, GL.GL_LUMINANCE, GL.GL_UNSIGNED_BYTE, Address_To_GLpointer(SaturationTexture.Pixels));
      GL.glTexParameteri(GL.GL_TEXTURE_2D, GL.GL_TEXTURE_MIN_FILTER, GL.GL_LINEAR);
      GL.glTexParameteri(GL.GL_TEXTURE_2D, GL.GL_TEXTURE_MAG_FILTER, GL.GL_LINEAR);

      -- TODO: Free the texture surface.
      SDL.Video.FreeSurface(SaturationTexture);
...
--    New_Line;
    ...
    GL.glTexCoordPointer(2, GL.GL_FLOAT, 0, Mesh.GetTextureCoords(Cube));
