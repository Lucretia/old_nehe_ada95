...
private
  ...
  Title               : String                := "CVA & Multipass Rendering Demo in Ada/SDL";
  Width               : Integer               := 640;
  Height              : Integer               := 480;
  ...
  FPS                 : Float                 := 0.0;
  GradientTexture     : SDL.Video.Surface_Ptr := null;
  SaturationTexture   : SDL.Video.Surface_Ptr := null;
  GradientTextureID   : GL.GLuint             := 0;
  SaturationTextureID : GL.GLuint             := 0;
