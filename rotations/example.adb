...
package body Example is
  ...
  begin
    ...
    Put_Line("C            => Select Camera for rotation");
  ...
  begin
    ...
    GL.glScalef(GL.GLFloat'(4.0), 1.0, 4.0);
    GL.glTranslatef(GL.GLFloat'(0.0), -1.0, 0.0);
    ...
    -- Left cube.
    GL.glPushMatrix;
    GL.glTranslatef(GL.GLFloat'(-1.5), 0.0, 0.0);-- Translate 6 Units Into The Screen

    GL.glRotatef(XSpeed(LEFT), 1.0, 0.0, 0.0); -- Rotate On The Y-Axis By angle.
    GL.glRotatef(YSpeed(LEFT), 0.0, 1.0, 0.0); -- Rotate On The Y-Axis By angle.
    ...
    GL.glTranslatef(GL.GLFloat'(1.5), 0.0, 0.0);
    GL.glRotatef(XSpeed(RIGHT), 1.0, 0.0, 0.0); -- Rotate On The Y-Axis By angle.
    GL.glRotatef(YSpeed(RIGHT), 0.0, 1.0, 0.0); -- Rotate On The Y-Axis By angle.
