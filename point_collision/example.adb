...
--  procedure Update(Ticks : in Integer) is
  ...
  begin
    ...
    if Keys(SDL.Keysym.K_R) = True then
      ...
      Dot                := Vector3.Object'(0.0, 0.0, 0.0);
    ...
    if Keys(SDL.Keysym.K_N) = True and NPressed = False then
      ...
      if ShiftPressed = True then
        ...
        Dot.X := Dot.X - DotSmallDelta;
          
      else
        
        Dot.X := Dot.X - DotDelta;
    ...
    if Keys(SDL.Keysym.K_O) = True and OPressed = False then
      ...
      if ShiftPressed = True then
        ...
        Dot.Y := Dot.Y + DotSmallDelta;
          
      else
        
        Dot.Y := Dot.Y + DotDelta;
  ...
  begin
    ...
    Collision := GM.CollisionDetected(TestPlane, Dot);
    ...
    GL.glBegin(GL.GL_POINTS);
      ...
      GL.glVertex3f(GL.GLfloat(Dot.X), GL.GLfloat(Dot.Y), GL.GLfloat(Dot.Z));
